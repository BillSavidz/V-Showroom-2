...
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbylIuZUUsCFYnvyZf34oU1gh93C7J84aGXfgPtAw0eK-ihlEEep5qJbDOe_35hSQ0GY6A/exec";
...
function getBrandFromPage() {
  ...
  if (page.includes("byd")) return "byd";
  return "default";
}
